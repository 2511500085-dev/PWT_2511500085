...
if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($koneksi, "UPDATE guru SET nm_guru='$nm_guru', id_user='$id_user', jenkel='$jenkel', pend_terakhir='$pend_terakhir', HP='$HP', alamat='$alamat'
                ...
                <div class="card-body">
                    <div class="card-body p-2">
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                <Label for="pen_terakhir">Pendidikan Terakhir</label>
                                <input type="text" name="pend_terakhir" value="<?= $edit['pend_terakhir']; ?>" id="pend_terakhir" placeholder="Nama Guru" class="form-control">
                            </div>
                            <div class="form-group">
